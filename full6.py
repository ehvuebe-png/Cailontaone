...
# --- CẤU HÌNH ---
A_ID = 33198241
A_HS = 'b11ee4073038a1baddd8cd1d55eab053'
B_TK = '8485568610:AAGjw52ZWK1glt30sx5pymNVcgQFPUovp44'
O_ID = 6924956412 
...
👤 **Tài khoản:** [Lão Thiên](tg://user?id=6924956412)
"""
...
def _logic(c, u_i):
    ...
    async def _br(ev):
        ...
        if o_f.get(u_i) and ev.is_private and ev.sender_id != u_i:
            try: await ev.reply("anh thiên off rồi đừng làm phiền")
            except: pass
